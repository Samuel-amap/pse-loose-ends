...
struct Model9_E3 <: AbstractP9Model
 end
...
function PlantSimEngine.inputs_(::Model9_E3)
	(a1_9 = -Inf, )
end
...
function PlantSimEngine.outputs_(::Model9_E3)
	(out9 = -Inf, )
end
...
function PlantSimEngine.run!(::Model3_E1, models, status, meteo, constants=nothing, sim_object=nothing)
	status.a3_6 = 1.0+ status.a2_3
	status.a3_10 = 1.0+ status.a2_3
status.out3 = 1.0
end
...
function PlantSimEngine.run!(::Model9_E3, models, status, meteo, constants=nothing, sim_object=nothing)
status.out9 = 1.0
end
...
Model6_E1(),
Model7_E1(),
Status(a1_2 = 1.0, a1_9 = 1.0, a2_3 = 1.0, a3_6 = 1.0, a3_10 = 1.0, a4_5 = 1.0, ),
),
"E2" => (
MultiScaleModel(
model = Model5_E2(),
mapped_variables=[:a4_5 => "E1" => :a4_5,]
),
Status(a5_8 = 1.0, ),
),
"E3" => (
MultiScaleModel(
model = Model8_E3(),
mapped_variables=[:a5_8 => "E2" => :a5_8,]
),
MultiScaleModel(
model = Model9_E3(),
mapped_variables=[:a1_9 => "E1" => :a1_9,]
),
Status(),
),
"E4" => (
MultiScaleModel(
model = Model10_E4(),
mapped_variables=[:a3_10 => "E1" => :a3_10,]
),
Status(),
),
)

outs = Dict("E1" => (:out1,:out2,:out3,:out4,:out6,:out7,),
"E2" => (:out5,),
"E3" => (:out8,:out9,),
"E4" => (:out10,),
)
...
generated_test_1234_1_sim = generated_test_1234_1.run!(generated_test_1234_1.mtg, generated_test_1234_1.mapping, generated_test_1234_1.meteo, outputs = generated_test_1234_1.outs)